...
{    char __cminus_stack_anchor;
    ...
    __right_value6 = cminus_string_format("aaa");
    struct Person *person = ({ struct Person* __right_value7 = cminus_gc_calloc(1, sizeof(struct Person)); if (__right_value7 != NULL) { __right_value7->name = __right_value6; __right_value7->age = 48; } __right_value7; });

    if (!cminus_string_eq(person->name, "aaa")) {
