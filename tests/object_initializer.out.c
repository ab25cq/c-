...
{    char __cminus_stack_anchor;
    ...
    __right_value0 = cminus_string_format("aaa");
    struct Person *person = ({ struct Person* __right_value1 = cminus_gc_calloc(1, sizeof(struct Person)); if (__right_value1 != NULL) { __right_value1->name = __right_value0; __right_value1->age = 48; } __right_value1; });
