...
enum TypedValues {
    TYPED_VALUE_ZERO, /* a comma, inside trivia must not split a member */
    TYPED_VALUE_FOUR = 1 << 2,
    TYPED_VALUE_FIVE,
};
...
{    char __cminus_stack_anchor;
    ...
    enum TypedValues value = TYPED_VALUE_FIVE;
    __typeof__((value == 5 ? 0 : 1)) __cminus_return6 = (value == 5 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
