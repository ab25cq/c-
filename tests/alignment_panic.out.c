...
{    char __cminus_stack_anchor;
    ...
    unsigned long value = cminus_align_up_impl((unsigned long)(1u), (unsigned long)( 0u), "tests/alignment_panic.c-", 3);
    __typeof__((value == 0u ? 0 : 1)) __cminus_return6 = (value == 0u ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
