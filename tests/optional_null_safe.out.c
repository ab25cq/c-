...
enum {
    Optional_int_TAG_Some,
    Optional_int_TAG_None
};
static __attribute__((unused)) struct Optional_int Optional_int_Some(int value)
{
    struct Optional_int out = {0};
    out.tag = Optional_int_TAG_Some;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    out.payload.Some = value;
    return out;
}
static __attribute__((unused)) int Optional_int_is_Some(struct Optional_int* self)
{
    return self->tag == Optional_int_TAG_Some;
}
static __attribute__((unused)) int Optional_int_get_Some(struct Optional_int* self)
{
    return self->payload.Some;
}
static __attribute__((unused)) struct Optional_int Optional_int_None(void)
{
    struct Optional_int out = {0};
    out.tag = Optional_int_TAG_None;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    return out;
}
static __attribute__((unused)) int Optional_int_is_None(struct Optional_int* self)
{
    return self->tag == Optional_int_TAG_None;
}
...
struct Optional_int maybe_value(int flag)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);

    if (flag) {
        __typeof__((Optional_int_Some(7))) __cminus_return6 = (Optional_int_Some(7));
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return6;
    }
    __typeof__((Optional_int_None())) __cminus_return7 = (Optional_int_None());
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return7;
}

int take_optional(struct Optional_int value)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);

    if (Optional_int_is_Some(&value)) {
        __typeof__((Optional_int_get_Some(&value))) __cminus_return8 = (Optional_int_get_Some(&value));
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    ...
    struct Optional_int value = Optional_int_None();
    struct Optional_int none = maybe_value(0);
    ...
    if (Optional_int_is_Some(&none)) {
        __typeof__((2)) __cminus_return11 = (2);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return11;
    }
    if (take_optional(Optional_int_None()) != 0) {
        __typeof__((3)) __cminus_return12 = (3);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return12;
    }
    struct Optional_int some = Optional_int_Some(5);
    if (take_optional(some) != 5) {
