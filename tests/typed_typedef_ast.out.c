...
typedef Word Counter;
typedef int (*Unary)(int);

Counter cminus_typedef_ast_probe(Counter value)
{
...
{    char __cminus_stack_anchor;
    ...
    __typeof__((cminus_typedef_ast_probe(4) == 5 ? 0 : 1)) __cminus_return6 = (cminus_typedef_ast_probe(4) == 5 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
