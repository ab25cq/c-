...
struct Span_unsigned_char Span_from_unsigned_char(unsigned char* data, int len){
...
struct FixedVec_unsigned_char FixedVec_from_unsigned_char(unsigned char* data, int cap){
...
{    char __cminus_stack_anchor;
    ...
    all = Span_from_unsigned_char(pkt.bytes, 8);
    used = FixedVec_from_unsigned_char(pkt.bytes, 8);
