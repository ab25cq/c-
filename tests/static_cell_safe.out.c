...
struct StaticCell_int StaticCell_uninit_int(void);
int StaticCell_is_initialized_int(struct StaticCell_int* self);
int StaticCell_get_int(struct StaticCell_int* self);
void StaticCell_set_int(struct StaticCell_int* self, int value);
int StaticCell_replace_int(struct StaticCell_int* self, int value);
...
{    char __cminus_stack_anchor;
    ...
    struct StaticCell_int cell = StaticCell_uninit_int();
    int old = {0};
    memset(&old, 0, sizeof(old));


    if (StaticCell_is_initialized_int(&cell)) {
        __typeof__((1)) __cminus_return6 = (1);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return6;
    }
    StaticCell_set_int(&cell, 10);
    old = StaticCell_replace_int(&cell, 20);
    if (old != 10) {
        __typeof__((2)) __cminus_return7 = (2);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return7;
    }
    __typeof__((StaticCell_get_int(&cell) == 20 ? 0 : 3)) __cminus_return8 = (StaticCell_get_int(&cell) == 20 ? 0 : 3);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
