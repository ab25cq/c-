...
{    char __cminus_stack_anchor;
    ...
    int a = 10;
    int b = 0;
    __typeof__((a / ({ __auto_type __divisor6 = (b); if (__divisor6 == 0) { cminus_panic("division by zero", "tests/division_panic.c-", 5); } __divisor6; }))) __cminus_return7 = (a / ({ __auto_type __divisor6 = (b); if (__divisor6 == 0) { cminus_panic("division by zero", "tests/division_panic.c-", 5); } __divisor6; }));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
