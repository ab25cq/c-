...
{    char __cminus_stack_anchor;
    ...
    if (({ char* __right_value0 = NULL; __right_value0 = cminus_string_format("abc"); int __right_value_cond1 = (!cminus_string_eq(__right_value0, "abc")) != 0; cminus_gc_free(__right_value0); __right_value_cond1; })) {
        if (text != NULL) {
            cminus_gc_free(text);
        }
