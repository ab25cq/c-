...
struct __CMinusIndex_unsigned_char{
    int tag;
    unsigned long origin_kind;
    unsigned long origin_stack_id;
    union {
...
enum {
    __CMinusIndex_unsigned_char_TAG_Some,
    __CMinusIndex_unsigned_char_TAG_None
};
static __attribute__((unused)) struct __CMinusIndex_unsigned_char __CMinusIndex_unsigned_char_Some(unsigned char value)
{
    struct __CMinusIndex_unsigned_char out = {0};
    out.tag = __CMinusIndex_unsigned_char_TAG_Some;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    out.payload.Some = value;
    return out;
}
static __attribute__((unused)) int __CMinusIndex_unsigned_char_is_Some(struct __CMinusIndex_unsigned_char* self)
{
    return self->tag == __CMinusIndex_unsigned_char_TAG_Some;
}
static __attribute__((unused)) unsigned char __CMinusIndex_unsigned_char_get_Some(struct __CMinusIndex_unsigned_char* self)
{
    return self->payload.Some;
}
static __attribute__((unused)) struct __CMinusIndex_unsigned_char __CMinusIndex_unsigned_char_None(void)
{
    struct __CMinusIndex_unsigned_char out = {0};
    out.tag = __CMinusIndex_unsigned_char_TAG_None;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    return out;
}
static __attribute__((unused)) int __CMinusIndex_unsigned_char_is_None(struct __CMinusIndex_unsigned_char* self)
{
    return self->tag == __CMinusIndex_unsigned_char_TAG_None;
}
...
struct RingBuffer_unsigned_char{
    unsigned char* data;
    int cap;
    int head;
    int len;
...
#define __CMINUS_DEFAULT_SELECT_Span_from_unsigned_char(_1, _2, _3, NAME, ...) NAME
#define __CMINUS_DEFAULT_Span_from_unsigned_char_2(data, len) Span_from_unsigned_char(data, len, 0)
#define __CMINUS_DEFAULT_Span_from_unsigned_char_3(data, len, allow_raw) Span_from_unsigned_char(data, len, allow_raw)
#define Span_from_unsigned_char(...) __CMINUS_DEFAULT_SELECT_Span_from_unsigned_char(__VA_ARGS__, __CMINUS_DEFAULT_Span_from_unsigned_char_3, __CMINUS_DEFAULT_Span_from_unsigned_char_2)(__VA_ARGS__)
struct Span_unsigned_char Span_from_unsigned_char(unsigned char* data, int len, int allow_raw);
struct Span_unsigned_char Span_empty_unsigned_char(void);
int Span_len_unsigned_char(struct Span_unsigned_char* self);
int Span_set_unsigned_char(struct Span_unsigned_char* self, int index, unsigned char value);
unsigned char* Span_ptr_at_unsigned_char(struct Span_unsigned_char* self, int index, const char* file, int line);
#define __CMINUS_DEFAULT_SELECT_RingBuffer_from_unsigned_char(_1, _2, _3, NAME, ...) NAME
#define __CMINUS_DEFAULT_RingBuffer_from_unsigned_char_2(data, cap) RingBuffer_from_unsigned_char(data, cap, 0)
#define __CMINUS_DEFAULT_RingBuffer_from_unsigned_char_3(data, cap, allow_raw) RingBuffer_from_unsigned_char(data, cap, allow_raw)
#define RingBuffer_from_unsigned_char(...) __CMINUS_DEFAULT_SELECT_RingBuffer_from_unsigned_char(__VA_ARGS__, __CMINUS_DEFAULT_RingBuffer_from_unsigned_char_3, __CMINUS_DEFAULT_RingBuffer_from_unsigned_char_2)(__VA_ARGS__)
struct RingBuffer_unsigned_char RingBuffer_from_unsigned_char(unsigned char* data, int cap, int allow_raw);
int RingBuffer_len_unsigned_char(struct RingBuffer_unsigned_char* self);
int RingBuffer_capacity_unsigned_char(struct RingBuffer_unsigned_char* self);
int RingBuffer_is_empty_unsigned_char(struct RingBuffer_unsigned_char* self);
int RingBuffer_is_full_unsigned_char(struct RingBuffer_unsigned_char* self);
int RingBuffer_push_unsigned_char(struct RingBuffer_unsigned_char* self, unsigned char value);
struct __CMinusIndex_unsigned_char RingBuffer_pop_opt_unsigned_char(struct RingBuffer_unsigned_char* self);
struct __CMinusIndex_unsigned_char RingBuffer_peek_opt_unsigned_char(struct RingBuffer_unsigned_char* self);
struct Span_unsigned_char RingBuffer_drain_to_span_unsigned_char(struct RingBuffer_unsigned_char* self, unsigned char* out, int cap);
...
static __attribute__((unused)) struct QueueStorage* QueueStorage_clone(struct QueueStorage* self)
{
    struct QueueStorage* copy = cminus_gc_calloc(1, sizeof(struct QueueStorage));
    if (copy == NULL || self == NULL) {
        return copy;
    }
    memcpy(copy->bytes, self->bytes, sizeof(copy->bytes));
    return copy;
}
...
static __attribute__((unused)) struct QueueOwner* QueueOwner_clone(struct QueueOwner* self)
{
    struct QueueOwner* copy = cminus_gc_calloc(1, sizeof(struct QueueOwner));
    if (copy == NULL || self == NULL) {
        return copy;
    }
    memcpy(copy->bytes, self->bytes, sizeof(copy->bytes));
...
int owner_capacity(struct QueueOwner *owner)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);

    struct RingBuffer_unsigned_char q = RingBuffer_from_unsigned_char(owner->bytes, (int)sizeof(owner->bytes), 0);

    __typeof__((RingBuffer_capacity_unsigned_char(&q))) __cminus_return6 = (RingBuffer_capacity_unsigned_char(&q));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    ...
    struct QueueStorage storage = {0};
    memset(&storage, 0, sizeof(storage));

    struct QueueOwner owner = {0};
    memset(&owner, 0, sizeof(owner));

    unsigned char drained_storage[3] = {0};
    memset(&drained_storage, 0, sizeof(drained_storage));

    struct RingBuffer_unsigned_char q = {0};
    memset(&q, 0, sizeof(q));

    struct Span_unsigned_char drained = {0};
    memset(&drained, 0, sizeof(drained));

    struct __CMinusIndex_unsigned_char item = {0};
    memset(&item, 0, sizeof(item));


    if (owner_capacity(&owner) != 5) {
        __typeof__((10)) __cminus_return7 = (10);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return7;
    }

    q = ({ cminus_stack_note_caller_range(storage.bytes, sizeof(storage.bytes)); RingBuffer_from_unsigned_char(storage.bytes, 4, 0); });
    if (RingBuffer_capacity_unsigned_char(&q) != 4 || !RingBuffer_is_empty_unsigned_char(&q)) {
        __typeof__((1)) __cminus_return8 = (1);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return8;
    }

    RingBuffer_push_unsigned_char(&q, 1);
    RingBuffer_push_unsigned_char(&q, 2);
    RingBuffer_push_unsigned_char(&q, 3);
    item = RingBuffer_pop_opt_unsigned_char(&q);
    if (__CMinusIndex_unsigned_char_is_None(&item) || __CMinusIndex_unsigned_char_get_Some(&item) != 1) {
        __typeof__((2)) __cminus_return9 = (2);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return9;
    }
    RingBuffer_push_unsigned_char(&q, 4);
    RingBuffer_push_unsigned_char(&q, 5);
    if (!RingBuffer_is_full_unsigned_char(&q) || RingBuffer_len_unsigned_char(&q) != 4) {
        __typeof__((3)) __cminus_return10 = (3);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return10;
    }
    item = RingBuffer_peek_opt_unsigned_char(&q);
    if (__CMinusIndex_unsigned_char_is_None(&item) || __CMinusIndex_unsigned_char_get_Some(&item) != 2) {
        __typeof__((4)) __cminus_return11 = (4);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return11;
    }

    drained = RingBuffer_drain_to_span_unsigned_char(&q, drained_storage, 3);
    if (Span_len_unsigned_char(&drained) != 3 || (*Span_ptr_at_unsigned_char(&(drained), 0, "tests/ring_buffer_safe.c-", 56)) != 2 || (*Span_ptr_at_unsigned_char(&(drained), 1, "tests/ring_buffer_safe.c-", 56)) != 3 || (*Span_ptr_at_unsigned_char(&(drained), 2, "tests/ring_buffer_safe.c-", 56)) != 4) {
        __typeof__((5)) __cminus_return12 = (5);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return12;
    }
    item = RingBuffer_pop_opt_unsigned_char(&q);
    if (__CMinusIndex_unsigned_char_is_None(&item) || __CMinusIndex_unsigned_char_get_Some(&item) != 5 || !RingBuffer_is_empty_unsigned_char(&q)) {
        __typeof__((6)) __cminus_return13 = (6);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return13;
    }
    __typeof__((0)) __cminus_return14 = (0);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return14;
}
#undef Span_from_unsigned_char
struct Span_unsigned_char Span_from_unsigned_char(unsigned char* data, int len, int allow_raw){
    struct Span_unsigned_char out;
    ...
    out.cap_bytes = out.cap * (int)sizeof(unsigned char);
    if (allow_raw) {
        out.origin_kind = __CMinusPtrKind_Raw;
    } else {
...
#undef RingBuffer_from_unsigned_char
struct RingBuffer_unsigned_char RingBuffer_from_unsigned_char(unsigned char* data, int cap, int allow_raw){
    struct RingBuffer_unsigned_char out;
    unsigned long stack_id = 0UL;
    ...
    if (allow_raw) {
        ...
        cminus_stack_note_caller_range(data, (size_t)out.cap * sizeof(unsigned char));
        out.origin_kind = cminus_ptr_classify(data, &stack_id);
    }
    out.origin_stack_id = stack_id;
    return out;
...
struct __CMinusIndex_unsigned_char RingBuffer_pop_opt_unsigned_char(struct RingBuffer_unsigned_char* self){
    ...
    if (self == NULL || self->len <= 0) {
        return __CMinusIndex_unsigned_char_None();
    }
    cminus_ptr_require_alive(self->data, self->origin_kind, self->origin_stack_id, __FILE__, __LINE__);
    ...
    return __CMinusIndex_unsigned_char_Some(value);
}
struct __CMinusIndex_unsigned_char RingBuffer_peek_opt_unsigned_char(struct RingBuffer_unsigned_char* self){
    if (self == NULL || self->len <= 0) {
        return __CMinusIndex_unsigned_char_None();
    ...
    return __CMinusIndex_unsigned_char_Some(self->data[self->head]);
}
struct Span_unsigned_char RingBuffer_drain_to_span_unsigned_char(struct RingBuffer_unsigned_char* self, unsigned char* out, int cap){
    struct Span_unsigned_char span;
    int count;
    int i;
    int index;

    if (self == NULL) {
        return Span_empty_unsigned_char();
    }
    cminus_ptr_require_alive(self->data, self->origin_kind, self->origin_stack_id, __FILE__, __LINE__);
    count = self->len;
    if (count > cap) {
    ...
    span = Span_from_unsigned_char(out, count, 0);
    i = 0;
    while (i < count) {
        index = (self->head + i) % self->cap;
        Span_set_unsigned_char(&span, i, self->data[index]);
        i++;
    }
