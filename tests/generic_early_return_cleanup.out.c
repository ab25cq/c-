...
int pick_int(int first, int second, int use_first);
...
{    char __cminus_stack_anchor;
    ...
    int a = pick_int(10, 20, 1);
    int b = pick_int(10, 20, 0);

    printf("%d\n", a + b);
    __typeof__((a == 10 && b == 20 ? 0 : 1)) __cminus_return6 = (a == 10 && b == 20 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return6;
}
int pick_int(int first, int second, int use_first){    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
