...
int Atomic_load_order_int(struct Atomic_int* self, int order);
...
{    char __cminus_stack_anchor;
    ...
    struct Atomic_int value = Atomic_init_int(1);

    __typeof__((Atomic_load_order_int(&value, AtomicRelease))) __cminus_return6 = (Atomic_load_order_int(&value, AtomicRelease));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
