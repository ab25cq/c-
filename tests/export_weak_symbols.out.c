...
__attribute__((used, externally_visible, section(".init.text"))) void kernel_entry(void)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
__attribute__((weak)) int board_timer_init(void)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
...
__attribute__((used, externally_visible, weak)) int board_magic = 42;
...
{    char __cminus_stack_anchor;
    ...
    kernel_entry();
    __typeof__((board_timer_init() == 7 && board_magic == 42 ? 0 : 1)) __cminus_return7 = (board_timer_init() == 7 && board_magic == 42 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
