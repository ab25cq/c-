...
struct Atomic_unsigned_int{
    unsigned int value;
};
struct Atomic_unsigned_int Atomic_init_unsigned_int(unsigned int value);
unsigned int Atomic_load_unsigned_int(struct Atomic_unsigned_int* self);
unsigned int Atomic_load_order_unsigned_int(struct Atomic_unsigned_int* self, int order);
unsigned int Atomic_exchange_unsigned_int(struct Atomic_unsigned_int* self, unsigned int value);
int Atomic_compare_exchange_order_unsigned_int(struct Atomic_unsigned_int* self, unsigned int expected, unsigned int desired, int success_order, int failure_order);
unsigned int Atomic_fetch_add_unsigned_int(struct Atomic_unsigned_int* self, unsigned int value);
unsigned int Atomic_fetch_or_unsigned_int(struct Atomic_unsigned_int* self, unsigned int value);
unsigned int Atomic_fetch_xor_unsigned_int(struct Atomic_unsigned_int* self, unsigned int value);
...
{    char __cminus_stack_anchor;
    ...
    struct Atomic_unsigned_int counter = Atomic_init_unsigned_int(1u);
    unsigned int old = {0};
    ...
    old = Atomic_fetch_add_unsigned_int(&counter, 2u);
    if (old != 1u || Atomic_load_unsigned_int(&counter) != 3u) {
        __typeof__((1)) __cminus_return6 = (1);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return6;
    }
    old = Atomic_fetch_or_unsigned_int(&counter, 0x10u);
    if (old != 3u || Atomic_load_unsigned_int(&counter) != 0x13u) {
        __typeof__((2)) __cminus_return7 = (2);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return7;
    }
    old = Atomic_fetch_xor_unsigned_int(&counter, 0x03u);
    if (old != 0x13u || Atomic_load_order_unsigned_int(&counter, AtomicSeqCst) != 0x10u) {
        __typeof__((5)) __cminus_return8 = (5);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return8;
    }
    old = Atomic_exchange_unsigned_int(&counter, 7u);
    if (old != 0x10u || Atomic_load_unsigned_int(&counter) != 7u) {
        __typeof__((3)) __cminus_return9 = (3);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return9;
    }
    swapped = Atomic_compare_exchange_order_unsigned_int(&counter, 7u, 9u, AtomicAcqRel, AtomicAcquire);
    if (!swapped || Atomic_load_unsigned_int(&counter) != 9u) {
        __typeof__((4)) __cminus_return10 = (4);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return10;
    }
    __typeof__((0)) __cminus_return11 = (0);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return11;
}
struct Atomic_unsigned_int Atomic_init_unsigned_int(unsigned int value){
    struct Atomic_unsigned_int out;
