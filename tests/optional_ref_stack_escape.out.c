...
struct Optional_Ref_int make_optional_ref(void)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
    ...
    __typeof__((Optional_Ref_int_Some(reference))) __cminus_return6 = (Optional_Ref_int_Some(reference));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    ...
    struct Optional_Ref_int maybe = make_optional_ref();
    struct Ref_int reference = Optional_Ref_int_get_Some(&maybe);
