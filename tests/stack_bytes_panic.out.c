...
{    char __cminus_stack_anchor;
    ...
    padding[0] = depth;
    if (depth == 0) {
        __typeof__((padding[0])) __cminus_return6 = (padding[0]);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return6;
    }
    __typeof__((descend(depth - 1) + padding[0])) __cminus_return7 = (descend(depth - 1) + padding[0]);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    ...
    __typeof__((descend(1000))) __cminus_return8 = (descend(1000));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
