...
{    char __cminus_stack_anchor;
    ...
    struct Holder *holder = cminus_gc_calloc(1, sizeof(struct Holder));    void* __owned_old6 = holder->text;
    holder->text = cminus_string_format("aaa");
    if (__owned_old6 != NULL) {
        cminus_gc_free(__owned_old6);
    }

    void* __owned_old7 = holder->text;
    holder->text = cminus_string_format("bbb");
