...
__attribute__((section(".vectors"), used)) int vectors[4];
__attribute__((aligned(4096))) int page_table[1024];
...
{    char __cminus_stack_anchor;
    ...
    __attribute__((aligned(16))) int stack_word = {0};
    memset(&stack_word, 0, sizeof(stack_word));


    vectors[0] = 7;
    page_table[0] = vectors[0];
    stack_word = page_table[0];
    __typeof__((stack_word)) __cminus_return6 = (stack_word);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
