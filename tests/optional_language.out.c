...
struct Optional_int make_some(int value)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);

    __typeof__((Optional_int_Some(value))) __cminus_return6 = (Optional_int_Some(value));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return6;
}

struct Optional_int make_none(void)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
...
{    char __cminus_stack_anchor;
    ...
    struct Optional_int some = make_some(42);
    struct Optional_int none = make_none();
    struct Optional_int inferred = Optional_int_Some(7);

    if (!Optional_int_is_Some(&some) || Optional_int_get_Some(&some) != 42) {
        __typeof__((1)) __cminus_return8 = (1);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return8;
    }
    if (!Optional_int_is_None(&none)) {
        __typeof__((2)) __cminus_return9 = (2);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return9;
    }
    if (!Optional_int_is_Some(&inferred) || Optional_int_get_Some(&inferred) != 7) {
        __typeof__((3)) __cminus_return10 = (3);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return10;
    }
    printf("%d %d\n", Optional_int_get_Some(&some), Optional_int_get_Some(&inferred));
