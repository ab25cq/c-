...
{    char __cminus_stack_anchor;
    ...
    char* out;
    out = cminus_string_format("aaa");
    __typeof__((out)) __cminus_return6 = (out);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
 {
        char* __right_value7 = x();

        char* p = __right_value7 + 1;
        if (__right_value7 != NULL) {
            cminus_gc_free(__right_value7);
        }
    ...
    if (({ char* __right_value11 = x(); int __right_value_cond12 = (__right_value11) != 0; if (__right_value11 != NULL) {
    cminus_gc_free(__right_value11);
}
__right_value_cond12; })) {
