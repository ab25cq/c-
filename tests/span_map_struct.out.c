...
{    char __cminus_stack_anchor;
    ...
    raw[0] = 3;
    raw[1] = 4;
    if ((*Span_ptr_at_Data(&(values), 0, "tests/span_map_struct.c-", 19)).a != 3 || (*Span_ptr_at_Data(&(values), 0, "tests/span_map_struct.c-", 19)).b != 4) {
        __typeof__((1)) __cminus_return6 = (1);
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return6;
    }
    printf("%d %d\n", (*Span_ptr_at_Data(&(values), 0, "tests/span_map_struct.c-", 20)).a, (*Span_ptr_at_Data(&(values), 0, "tests/span_map_struct.c-", 20)).b);
