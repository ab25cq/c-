...
{    char __cminus_stack_anchor;
    ...
    if (({ char* __right_value0 = NULL; __right_value0 = cminus_string_format("if"); int __right_value_cond1 = (cminus_string_eq(__right_value0, "if")) != 0; cminus_gc_free(__right_value0); __right_value_cond1; })) {
        count++;
    } else if (({ char* __right_value2 = NULL; __right_value2 = cminus_string_format("else"); int __right_value_cond3 = (cminus_string_eq(__right_value2, "else")) != 0; cminus_gc_free(__right_value2); __right_value_cond3; })) {
        count = 100;
    }

    while (({ char* __right_value4 = NULL; __right_value4 = cminus_string_format("while"); int __right_value_cond5 = (count < 2 && cminus_string_eq(__right_value4, "while")) != 0; cminus_gc_free(__right_value4); __right_value_cond5; })) {
        count++;
    }

    do {
        count++;
    } while (({ char* __right_value6 = NULL; __right_value6 = cminus_string_format("do"); int __right_value_cond7 = (count < 4 && cminus_string_eq(__right_value6, "do")) != 0; cminus_gc_free(__right_value6); __right_value_cond7; }));
