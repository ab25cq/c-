...
{    char __cminus_stack_anchor;
    ...
    if (({ char* __right_value6 = NULL; __right_value6 = cminus_string_format("if"); int __right_value_cond7 = (cminus_string_eq(__right_value6, "if")) != 0; cminus_gc_free(__right_value6); __right_value_cond7; })) {
        count++;
    } else if (({ char* __right_value8 = NULL; __right_value8 = cminus_string_format("else"); int __right_value_cond9 = (cminus_string_eq(__right_value8, "else")) != 0; cminus_gc_free(__right_value8); __right_value_cond9; })) {
        count = 100;
    }

    while (({ char* __right_value10 = NULL; __right_value10 = cminus_string_format("while"); int __right_value_cond11 = (count < 2 && cminus_string_eq(__right_value10, "while")) != 0; cminus_gc_free(__right_value10); __right_value_cond11; })) {
        count++;
    }

    do {
        count++;
    } while (({ char* __right_value12 = NULL; __right_value12 = cminus_string_format("do"); int __right_value_cond13 = (count < 4 && cminus_string_eq(__right_value12, "do")) != 0; cminus_gc_free(__right_value12); __right_value_cond13; }));

    __typeof__((count == 4 ? 0 : 1)) __cminus_return14 = (count == 4 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
