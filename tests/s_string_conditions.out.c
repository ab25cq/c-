...
{    char __cminus_stack_anchor;
    ...
    if (({ char* __right_value0 = NULL; asprintf(&__right_value0, "if"); int __right_value_cond1 = (strcmp(__right_value0, "if") == 0) != 0; cminus_gc_free(__right_value0); __right_value_cond1; })) {
        count++;
    } else if (({ char* __right_value2 = NULL; asprintf(&__right_value2, "else"); int __right_value_cond3 = (strcmp(__right_value2, "else") == 0) != 0; cminus_gc_free(__right_value2); __right_value_cond3; })) {
        count = 100;
    }

    while (({ char* __right_value4 = NULL; asprintf(&__right_value4, "while"); int __right_value_cond5 = (count < 2 && strcmp(__right_value4, "while") == 0) != 0; cminus_gc_free(__right_value4); __right_value_cond5; })) {
        count++;
    }

    do {
        count++;
    } while (({ char* __right_value6 = NULL; asprintf(&__right_value6, "do"); int __right_value_cond7 = (count < 4 && strcmp(__right_value6, "do") == 0) != 0; cminus_gc_free(__right_value6); __right_value_cond7; }));
