...
#define __CMINUS_DEFAULT_SELECT_choose_int(_1, _2, _3, NAME, ...) NAME
#define __CMINUS_DEFAULT_choose_int_1(a) choose_int(a, 20, 3)
#define __CMINUS_DEFAULT_choose_int_2(a, b) choose_int(a, b, 3)
#define __CMINUS_DEFAULT_choose_int_3(a, b, c) choose_int(a, b, c)
#define choose_int(...) __CMINUS_DEFAULT_SELECT_choose_int(__VA_ARGS__, __CMINUS_DEFAULT_choose_int_3, __CMINUS_DEFAULT_choose_int_2, __CMINUS_DEFAULT_choose_int_1)(__VA_ARGS__)
int choose_int(int a, int b, int c);
...
{    char __cminus_stack_anchor;
    ...
    int a = choose_int(2, 20, 3);
    int b = choose_int(2, 4, 3);
    int c = choose_int(2, 4, 5);
    int d = choose_int(2, 20, 5);
    int e = choose_int(1, 20, 7);
...
#undef choose_int
int choose_int(int a, int b, int c){    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);
