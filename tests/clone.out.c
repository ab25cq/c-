...
{    char __cminus_stack_anchor;
    ...
    char* right_copy =({ char* __right_value_src5 = p->right; char* __right_value6 = NULL; if (__right_value_src5 != NULL) { __right_value6 = cminus_gc_calloc(strlen(__right_value_src5) + 1, sizeof(char)); strncpy(__right_value6, __right_value_src5, strlen(__right_value_src5) + 1); } __right_value6; });
    struct Pair *q =({ struct Pair* __right_value_src7 = p; struct Pair* __right_value8 = NULL; if (__right_value_src7 != NULL) { __right_value8 = Pair_clone(__right_value_src7); } __right_value8; });
