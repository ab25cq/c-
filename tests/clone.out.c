...
static void Pair_finalize(struct Pair* self)
{
    ...
    if (self->left != NULL) {
        cminus_gc_free(self->left);
    }

    if (self->right != NULL) {
        cminus_gc_free(self->right);
    }
...
{
    struct Pair* copy = cminus_gc_calloc(1, sizeof(struct Pair));
    if (copy == NULL || self == NULL) {
        return copy;
    }
    if (self->left != NULL) {
        copy->left = cminus_gc_calloc(strlen(self->left) + 1, sizeof(char));
        strncpy(copy->left, self->left, strlen(self->left) + 1);
    }
    if (self->right != NULL) {
        copy->right = cminus_gc_calloc(strlen(self->right) + 1, sizeof(char));
        strncpy(copy->right, self->right, strlen(self->right) + 1);
    }
    return copy;
}
...
{    char __cminus_stack_anchor;
    ...
    char* __right_value6 = NULL;
    __right_value6 = cminus_string_format("7");
    char* __right_value7 = NULL;
    __right_value7 = cminus_string_format("9");
    struct Pair *p = ({ struct Pair* __right_value8 = cminus_gc_calloc(1, sizeof(struct Pair)); if (__right_value8 != NULL) { __right_value8->left = __right_value6; __right_value8->right = __right_value7; } __right_value8; });

    char* left_copy =({ char* __right_value_src9 = p->left; char* __right_value10 = NULL; if (__right_value_src9 != NULL) { __right_value10 = cminus_gc_calloc(strlen(__right_value_src9) + 1, sizeof(char)); strncpy(__right_value10, __right_value_src9, strlen(__right_value_src9) + 1); } __right_value10; });
    char* right_copy =({ char* __right_value_src11 = p->right; char* __right_value12 = NULL; if (__right_value_src11 != NULL) { __right_value12 = cminus_gc_calloc(strlen(__right_value_src11) + 1, sizeof(char)); strncpy(__right_value12, __right_value_src11, strlen(__right_value_src11) + 1); } __right_value12; });
    struct Pair *q =({ struct Pair* __right_value_src13 = p; struct Pair* __right_value14 = NULL; if (__right_value_src13 != NULL) { __right_value14 = Pair_clone(__right_value_src13); } __right_value14; });

    if (left_copy == NULL || right_copy == NULL || q == NULL) {
        __typeof__((1)) __cminus_return15 = (1);
        if (q != NULL) {
            Pair_finalize(q);
            cminus_gc_free(q);
        }
        ...
        if (right_copy != NULL) {
            cminus_gc_free(right_copy);
        }

        if (left_copy != NULL) {
            cminus_gc_free(left_copy);
        }
    ...
    if (!cminus_string_eq(left_copy, "7") || !cminus_string_eq(right_copy, "9")) {
        ...
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return16;
    }
    if (q->left == NULL || q->right == NULL) {
        __typeof__((3)) __cminus_return17 = (3);
        if (q != NULL) {
            Pair_finalize(q);
            cminus_gc_free(q);
        }
        ...
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return17;
    }
    if (q->left == p->left || q->right == p->right) {
        __typeof__((4)) __cminus_return18 = (4);
        if (q != NULL) {
            Pair_finalize(q);
            cminus_gc_free(q);
        }
        ...
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return18;
    }
    if (!cminus_string_eq(q->left, "7") || !cminus_string_eq(q->right, "9")) {
        __typeof__((5)) __cminus_return19 = (5);
        if (q != NULL) {
            Pair_finalize(q);
            cminus_gc_free(q);
        }
        ...
        cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
        return __cminus_return19;
    }
    __typeof__((0)) __cminus_return20 = (0);
    if (q != NULL) {
        Pair_finalize(q);
        cminus_gc_free(q);
    }
