...
struct Register_unsigned_int{
    volatile unsigned int* addr;
};
struct Register_unsigned_int Register_from_addr_unsigned_int(unsigned long addr);
unsigned int Register_read_unsigned_int(struct Register_unsigned_int* self);
void Register_write_unsigned_int(struct Register_unsigned_int* self, unsigned int value);
void Register_set_bits_unsigned_int(struct Register_unsigned_int* self, unsigned int mask);
void Register_clear_bits_unsigned_int(struct Register_unsigned_int* self, unsigned int mask);
unsigned int Register_get_bits_unsigned_int(struct Register_unsigned_int* self, unsigned int mask);
int Register_has_bits_unsigned_int(struct Register_unsigned_int* self, unsigned int mask);
void Register_replace_bits_unsigned_int(struct Register_unsigned_int* self, unsigned int mask, unsigned int value);
...
{    char __cminus_stack_anchor;
    ...
    unsigned int cell = 0;
    struct Register_unsigned_int reg = {0};
    memset(&reg, 0, sizeof(reg));
 {
        reg = Register_from_addr_unsigned_int((unsigned long)&cell);
    }

    Register_write_unsigned_int(&reg, 0x10u);
    Register_set_bits_unsigned_int(&reg, 0x03u);
    Register_clear_bits_unsigned_int(&reg, 0x01u);
    Register_replace_bits_unsigned_int(&reg, 0x30u, 0x20u);
    __typeof__((Register_read_unsigned_int(&reg) == 0x22u && Register_get_bits_unsigned_int(&reg, 0x30u) == 0x20u && Register_has_bits_unsigned_int(&reg, 0x02u) ? 0 : 1)) __cminus_return6 = (Register_read_unsigned_int(&reg) == 0x22u && Register_get_bits_unsigned_int(&reg, 0x30u) == 0x20u && Register_has_bits_unsigned_int(&reg, 0x02u) ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
    return __cminus_return6;
}
struct Register_unsigned_int Register_from_addr_unsigned_int(unsigned long addr){
    struct Register_unsigned_int out;

    out.addr = (volatile unsigned int*)addr;
    return out;
}
unsigned int Register_read_unsigned_int(struct Register_unsigned_int* self){
