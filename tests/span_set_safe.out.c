...
{    char __cminus_stack_anchor;
    ...
    Span_set_int(&values, 0, 11);
    Span_set_int(&values, 1, 22);
    Span_set_int(&values, 2, 33);
    __typeof__((Span_get_int(&values, 0) + Span_get_int(&values, 1) + Span_get_int(&values, 2) == 66 ? 0 : 1)) __cminus_return6 = (Span_get_int(&values, 0) + Span_get_int(&values, 1) + Span_get_int(&values, 2) == 66 ? 0 : 1);
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
