...
{    char __cminus_stack_anchor;
    ...
    struct Span_int values = ({ cminus_stack_note_caller_range(holder->data, sizeof(holder->data)); Span_from_int(holder->data, 3, 0); });
    struct Span_int bytes = ({ cminus_stack_note_caller_range(holder->data, sizeof(holder->data)); Span_from_bytes_int(holder->data, sizeof(holder->data), 0); });
    int n = {0};
    memset(&n, 0, sizeof(n));
    ...
    if ((*Span_ptr_at_int(&(values), 2, "tests/span_field_ok.c-", 18)) != 30) {
