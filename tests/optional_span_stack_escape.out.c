...
struct Optional_Span_int{
    int tag;
    unsigned long origin_kind;
    unsigned long origin_stack_id;
    union {
        struct Span_int Some;
    } payload;
};
enum {
    Optional_Span_int_TAG_Some,
    Optional_Span_int_TAG_None
};
static __attribute__((unused)) struct Optional_Span_int Optional_Span_int_Some(struct Span_int value)
{
    struct Optional_Span_int out = {0};
    out.tag = Optional_Span_int_TAG_Some;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    out.payload.Some = value;
    return out;
}
static __attribute__((unused)) int Optional_Span_int_is_Some(struct Optional_Span_int* self)
{
    return self->tag == Optional_Span_int_TAG_Some;
}
static __attribute__((unused)) struct Span_int Optional_Span_int_get_Some(struct Optional_Span_int* self)
{
    return self->payload.Some;
}
static __attribute__((unused)) struct Optional_Span_int Optional_Span_int_None(void)
{
    struct Optional_Span_int out = {0};
    out.tag = Optional_Span_int_TAG_None;
    out.origin_kind = 0UL;
    out.origin_stack_id = 0UL;
    return out;
}
static __attribute__((unused)) int Optional_Span_int_is_None(struct Optional_Span_int* self)
{
    return self->tag == Optional_Span_int_TAG_None;
}
...
struct Optional_Span_int make_optional_span(void)
{    char __cminus_stack_anchor;
    size_t __cminus_stack_id = cminus_stack_enter_impl(__FILE__, __LINE__, &__cminus_stack_anchor);

    int values[2] = { 3, 4 };
    struct Span_int view = ({ cminus_stack_note_caller_range(values, sizeof(values)); Span_from_int(values, 2, 0); });

    __typeof__((Optional_Span_int_Some(view))) __cminus_return6 = (Optional_Span_int_Some(view));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
...
{    char __cminus_stack_anchor;
    ...
    struct Optional_Span_int maybe = make_optional_span();
    struct Span_int view = Optional_Span_int_get_Some(&maybe);

    __typeof__((Span_get_int(&view, 0))) __cminus_return7 = (Span_get_int(&view, 0));
    cminus_stack_leave_impl(__cminus_stack_id, __FILE__, __LINE__);
